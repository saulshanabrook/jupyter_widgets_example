...
# -*- coding: utf-8 -*-
#
# python_package_name documentation build configuration file
#
...
_version_py = os.path.join(repo, 'python_package_name', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'python_package_namedoc'
...
latex_documents = [
    (master_doc, 'python_package_name.tex', 'python_package_name Documentation',
     'author_name', 'manual'),
]
...
man_pages = [
    (master_doc,
    'python_package_name',
    'python_package_name Documentation',
     [author], 1)
]
